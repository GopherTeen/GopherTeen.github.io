window.addEventListener("load", () => {
    ...
    const search = () => {
        ...
        $input.addEventListener("input", function () {
            ...
            if (keywords[0] !== "") $loadingStatus.innerHTML = '<i class="anzhiyufont anzhiyu-icon-spinner anzhiyu-pulse-icon"></i>';
                        ...
                        if (firstOccur >= 0) {
                            ...
                            if (dataTags.length) {
                                ...
                                for (let i = 0; i < dataTags.length; i++) {
                                    ...
                                    str += '<a class="tag-list" href="/tags/' + element + '/" data-pjax-state="" one-link-mark="yes">#' + element + "</a>";
                                }
