...
(function () {
        ...
        if (f) {
            ...
            e.onload = e.onreadystatechange = function () {
                g ||
                    ...
                    ((g = !0), c && c(null), (e.onload = e.onreadystatechange = null), "HEAD" == e.parentNode.tagName && f.removeChild(e));
            };
            f.appendChild(e);
            setTimeout(function () {
    ...
    var U = { latin: "BESbswy", cyrillic: "&#1081;&#1103;&#1046;", greek: "&#945;&#946;&#931;", khmer: "&#x1780;&#x1781;&#x1782;", Hanuman: "&#x1780;&#x1781;&#x1782;" },
        la = {
            thin: "1",
            extralight: "2",
            "extra-light": "2",
    ...
    T.prototype.parse = function () {
        for (var a = this.k.length, b = 0; b < a; b++) {
            ...
            if (2 <= c.length) {
                ...
                0 < e.length && (f = e);
                3 == c.length && ((c = c[2]), (e = []), (c = c ? c.split(",") : e), 0 < c.length && (c = U[c[0]]) && (this.G[d] = c));
            }
    ...
    pa.prototype.load = function (a) {
        ...
        for (c = f.length; b < c; b++) {
            var g = f[b].split(":");
            if (g[1]) for (var l = g[1].split(","), h = 0; h < l.length; h += 1) d.push(new A(g[0], l[h]));
